...
subroutine f_eval(ee,p1,p2,ip1,ip2,ie1,ie2,w,sig)
  ...
  real*8 :: stpp1,stp1,stp2,dp1,dp2
  real*8 :: qval,cos_theta,jac_c,tan2
  real*8 :: v_ll,v_t
  real*8 :: tnl2,sig0,delta,rho,rhop,pp1
  real*8 :: p1_4(4),p2_4(4),pp1_4(4),pp2_4(4),q_4(4),pp_4(4)
  ...
  if(q2.lt.0.0d0) stop
  qval=sqrt(q2+w**2)
!...I define the hadronic kinematic variables
...
!...Lepton Kinematic variables  
  ...
  call int_eval(p1_4,p2_4,pp1_4,pp2_4,q_4,dp1,dp2,r_now)
...
subroutine int_eval(p1_4,p2_4,pp1_4,pp2_4,q_4,dp1,dp2,r_now)
   use dirac_matrices         
   use mathtool
   implicit none
